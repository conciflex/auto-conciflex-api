...
__published:	// IDE-managed Components
	...
	TDataSource *DataPagamentosOperadoras2;
	TFDQuery *tbPagamentosOperadoras2;
	TFDAutoIncField *tbPagamentosOperadoras2CODIGO;
	TDateField *tbPagamentosOperadoras2DATA_PROCESSAMENTO;
	TTimeField *tbPagamentosOperadoras2HORA_PROCESSAMENTO;
	TStringField *tbPagamentosOperadoras2ID_LOJA;
	TDateField *tbPagamentosOperadoras2DATA_VENDA;
	TTimeField *tbPagamentosOperadoras2HORA_VENDA;
	TFloatField *tbPagamentosOperadoras2VALOR_BRUTO;
	TFloatField *tbPagamentosOperadoras2VALOR_DESCONTO;
	TFloatField *tbPagamentosOperadoras2VALOR_LIQUIDO;
	TStringField *tbPagamentosOperadoras2NUMERO_CARTAO;
	TStringField *tbPagamentosOperadoras2BANCO;
	TSingleField *tbPagamentosOperadoras2COD_BANCO;
	TStringField *tbPagamentosOperadoras2AGENCIA;
	TStringField *tbPagamentosOperadoras2CONTA;
	TStringField *tbPagamentosOperadoras2CODIGO_AUTORIZACAO;
	TStringField *tbPagamentosOperadoras2NSU;
	TSingleField *tbPagamentosOperadoras2COD_CLIENTE;
	TSingleField *tbPagamentosOperadoras2COD_STATUS;
	TSingleField *tbPagamentosOperadoras2COD_ADQUIRENTE;
	TSingleField *tbPagamentosOperadoras2TAXA_PERCENTUAL;
	TSingleField *tbPagamentosOperadoras2VALOR_TAXA;
	TSingleField *tbPagamentosOperadoras2COD_BANDEIRA;
	TSingleField *tbPagamentosOperadoras2COD_TIPO_PAGAMENTO;
	TStringField *tbPagamentosOperadoras2ENCONTRADA_VENDA;
	TDateField *tbPagamentosOperadoras2DATA_PAGAMENTO;
	TSingleField *tbPagamentosOperadoras2COD_GRUPO_CLIENTE;
	TStringField *tbPagamentosOperadoras2CNPJ;
	TStringField *tbPagamentosOperadoras2EMPRESA;
	TFloatField *tbPagamentosOperadoras2OUTROS_CREDITOS;
	TSingleField *tbPagamentosOperadoras2COD_MEIO_CAPTURA;
	TIntegerField *tbPagamentosOperadoras2PARCELA;
	TIntegerField *tbPagamentosOperadoras2TOTAL_PARCELAS;
	TSingleField *tbPagamentosOperadoras2COD_STATUS_FINANCEIRO;
	TStringField *tbPagamentosOperadoras2VINCULADO_VENDA;
	TSingleField *tbPagamentosOperadoras2COD_VENDA;
	TSingleField *tbPagamentosOperadoras2COD_FORMA_PAGAMENTO;
	TSingleField *tbPagamentosOperadoras2TAXA_MANUAL;
	TFloatField *tbPagamentosOperadoras2RESUMO_DESCONTO;
	TFloatField *tbPagamentosOperadoras2RESUMO_LIQUIDO;
	TFloatField *tbPagamentosOperadoras2DIFERENCA_DESCONTO;
	TFloatField *tbPagamentosOperadoras2DIFERENCA_LIQUIDO;
	TStringField *tbPagamentosOperadoras2IDENTIFICADOR_RO;
	TFloatField *tbPagamentosOperadoras2CALCULADO_DESCONTO;
	TFloatField *tbPagamentosOperadoras2CALCULADORA_LIQUIDO;
	TStringField *tbPagamentosOperadoras2RO_TRATADO;
	TDateField *tbPagamentosOperadoras2DATA_PREV_PAG_ORIGINAL;
	TStringField *tbPagamentosOperadoras2ID_VENDA_ERP;
	TStringField *tbPagamentosOperadoras2NOME_ARQUIVO;
	TSingleField *tbPagamentosOperadoras2COD_PRODUTO;
	TStringField *tbPagamentosOperadoras2TID;
	TStringField *tbPagamentosOperadoras2OBSERVACOES;
	TStringField *tbPagamentosOperadoras2DUPLICIDADE_VERIFICADA;
	TStringField *tbPagamentosOperadoras2NUMERO_RESUMO_VENDA;
	TStringField *tbPagamentosOperadoras2CHAVE_VENDA_OPERADORA;
	TStringField *tbPagamentosOperadoras2CHAVE_VENDA_ERP;
	TStringField *tbPagamentosOperadoras2CHAVE_PAGAMENTO;
	TStringField *tbPagamentosOperadoras2DIVERGENCIA;
	TStringField *tbPagamentosOperadoras2JUSTIFICATIVA;
	TSingleField *tbPagamentosOperadoras2TAXA_ANTECIPACAO;
	TFloatField *tbPagamentosOperadoras2VALOR_TAXA_ANTECIPACAO;
	TStringField *tbPagamentosOperadoras2NUMERO_TERMINAL;
	TStringField *tbPagamentosOperadoras2NUMERO_OPERACAO_ANTECIPACAO;
	TSingleField *tbPagamentosOperadoras2COD_TIPO_LANCAMENTO;
	TSingleField *tbPagamentosOperadoras2COD_AJUSTE;
	TStringField *tbPagamentosOperadoras2RETORNO_BAIXA;
	TStringField *tbPagamentosOperadoras2CHAVE_EXTRATO_BANCARIO;
	TDateField *tbPagamentosOperadoras2DATA_CANCELAMENTO;
	TSingleField *tbPagamentosOperadoras2COD_STATUS_EXTRATO_BANCARIO;
	TStringField *tbPagamentosOperadoras2FLAG_INFOTECH;
	TStringField *tbPagamentosOperadoras2AUTORIZADOR;
	TStringField *tbPagamentosOperadoras2CAMPO_ADICIONAL1;
	TStringField *tbPagamentosOperadoras2CAMPO_ADICIONAL2;
	TStringField *tbPagamentosOperadoras2CAMPO_ADICIONAL3;
	TFloatField *tbPagamentosOperadoras2VALOR_BRUTO_ERP;
	TStringField *tbPagamentosOperadoras2PERCENTUAL_TAXA_CALC;
	TSingleField *tbPagamentosOperadoras2COD_TIPO_INT_ERP;
	TStringField *tbPagamentosOperadoras2TAXA_MINIMA;
	TFloatField *tbPagamentosOperadoras2TARIFA_TRANSACAO;
